    ...
    vuforiaModule.directive('twxDtView', ['tml3dRenderer', '$rootScope', function (renderer, $rootScope) {
        ...
        function linkFunc( scope, element, attrs ) {
            ...
            var clickHandler = function(event) {
                ...
                var generateUserDefinedTargetOtherwiseUserPick = function () {
                    if (typeof(renderer.generateUserDefinedTarget) === "function") {
                        renderer.generateUserDefinedTarget(function () {
                            //Do nothing
                        }, function (error) {
                ...
                if (typeof(renderer.exitSpatialPlacementMode) === "function") {
                    renderer.exitSpatialPlacementMode(function () {
                        ...
                        generateUserDefinedTargetOtherwiseUserPick();
                    });
                } else {
                    generateUserDefinedTargetOtherwiseUserPick();
                }
