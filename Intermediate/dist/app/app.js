...
$scope.assignTrustedUrl = function() {
  $scope.view.wdg['video'].videosrc = 'https://www.youtube.com/watch?v=hx4sZwq8uoY';
};
...
function updateTitleWithExpTitle() {
  var defaultParams = {"vumark":{"id":"vumark","isbound":"false","isdeletable":"false","name":"ThingMark","value":""},"template":{"id":"template","isbound":"false","isdeletable":"false","name":"Thing Template","value":""},"thing":{"id":"thing","isbound":"false","isdeletable":"false","name":"Thing","value":""},"xCoordModel":{"id":"xCoordModel","isbound":"false","isdeletable":"true","name":"xCoordModel","value":""},"zCoordModelItem":{"id":"zCoordModelItem","isbound":"false","isdeletable":"true","name":"zCoordModelItem","value":""}};
...
var experienceInfo = new twx.app.ExperienceInfo({"name":"","version":"1.0.0","requires":["w320dp"],"experiences":[{"vumark":"36217:1","experienceType":"vumark","id":1,"index-keys":["urn:vuforia:vumark:36217:1"],"title":{"en":"Intermediate"},"description":{"en":"","en-US":""},"requires":["AR-tracking"],"tags":[],"icon":"","viewName":"Home","url-template":"index.html?expId=1&vumark={{vuforia:vumark}}","entryPoint":"index.html?expId=1","thumbnail":""}],"accessType":"private","designedfor":[]});
